        ...
        <div className="msg  mt-8 lg:mt-20 ml-10 lg:ml-28">
            <p className="message text-xl lg:text-7xl leading ">BECAUSE YOU DESERVE </p>
             ...
             >
              ...
              <a href="https://calendly.com/melavimelavi/30min" target="_blank" rel="noreferrer" className=" md:hidden" id=""> Book Now</a>
              <a href="https://calendly.com/melavimelavi/30min" target="_blank" rel="noreferrer" className="hidden md:block lg:text-2xl" id=""> Book Your Appointment</a>
             </button>
