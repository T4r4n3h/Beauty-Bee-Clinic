  ...
  const services = [
    {
        ...
        price:"$8 - $10/unit", 
        duration:"30 minutes",
        book:"https://calendly.com/melavimelavi/neurotoxin-botox"
    },
    {
        name:"Derma Filler",
        ...
        price:"$500 - $600",
        duration:"60 minutes",
        book:"https://calendly.com/melavimelavi/derma-filler-60-min"
    },
    {
        name:"Chemical Peels", 
        ...
        price:"$100 - $150", 
        duration:"30 minutes",
        book:"https://calendly.com/melavimelavi/chemical-peels-30-min"
    },
    {
        ...
        price:"", 
        duration:"30 minutes",
        book:"https://calendly.com/melavimelavi/vitamin-injections-30"
    },
    {   
        ...
        price:"$650/vial",
        duration:"45 minutes",
        book:"https://calendly.com/melavimelavi/fat-dissolving-solution-45-min"
    },
  ]
  return (
    <div className="SrvcCardMbl md:hidden flex flex-wrap justify-around">
       {services.map((srv)=> (<ServiceItem key= {srv.name} name={srv.name} description={srv.description} price={srv.price} duration={srv.duration} img={srv.img} book={srv.book}/>))}
