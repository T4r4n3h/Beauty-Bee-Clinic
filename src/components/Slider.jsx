...
function Slider() {
  ...
  return (
    <div className='Slider-container h-96 flex justify-center items-center '>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
      ...
      <div className="slider mb-2 w-full h-full whitespace-nowrap overflow-x-scroll pb-6">
      {slides.map((card)=> (<TestCard/>))}
