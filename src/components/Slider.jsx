...
function Slider() {
    ...
    const slides =[
      ...
      {id:5, name: '', msg:'blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah'},
      {id:6, name: '', msg:'g'},
    ]

  return (
    <div className='Slider-container h-[25rem] flex justify-center items-center border-2 border-blue-300'>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
      ...
      <div className="slider mb-2 w-full h-full whitespace-nowrap overflow-x-scroll  border border-purple-500">
